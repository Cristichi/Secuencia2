...
/**
 * Modos de Juego oficiales que funcionan por imágenes
 */
public enum ImageGamemode implements Gamemode<Integer> {
    ...
    ImageGamemode(String code, int name, @DrawableRes int icon, @DrawableRes int... values){
        this.code = code;
        if (code.length()>10){
